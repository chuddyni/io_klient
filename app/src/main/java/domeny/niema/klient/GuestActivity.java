...
//ustawianie listenerow
    ...
    private void view_all_buttonClicked() {
        ...
        if (CheckInternet.isOnline()) {
                        ...
                        for (final ParseObject Travel : TravelsList) {
                            ...
                            b.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    ll.addView(spacja3);
                                    ImageView image = new ImageView(GuestActivity.this);
                                    ...
                                    ll.addView(image);
                                    Picasso.with(GuestActivity.this).load(imageUri.toString()).networkPolicy(NetworkPolicy.NO_CACHE)
            ...
            Toast.makeText(GuestActivity.this, "No internet connection, trying again", Toast.LENGTH_LONG).show();
